...
void setup_scr_digital_settings(lv_ui *ui)
{
    ...
    lv_obj_set_style_text_color(ui->digital_settings_label_messages_bar, lv_color_hex(0xdbcfcf), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    //Write codes digital_settings_dog_emoji
    ui->digital_settings_dog_emoji = lv_img_create(ui->digital_settings);
    lv_obj_add_flag(ui->digital_settings_dog_emoji, LV_OBJ_FLAG_CLICKABLE);
    lv_img_set_src(ui->digital_settings_dog_emoji, &_dog_emoji_alpha_75x75);
    lv_img_set_pivot(ui->digital_settings_dog_emoji, 50,50);
    lv_img_set_angle(ui->digital_settings_dog_emoji, 0);
    lv_obj_set_pos(ui->digital_settings_dog_emoji, 37, 151);
    lv_obj_set_size(ui->digital_settings_dog_emoji, 75, 75);

    //Write style for digital_settings_dog_emoji, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_img_recolor_opa(ui->digital_settings_dog_emoji, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_img_opa(ui->digital_settings_dog_emoji, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->digital_settings_dog_emoji, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(ui->digital_settings_dog_emoji, true, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes digital_settings_phoenix_emoji
    ui->digital_settings_phoenix_emoji = lv_img_create(ui->digital_settings);
    lv_obj_add_flag(ui->digital_settings_phoenix_emoji, LV_OBJ_FLAG_CLICKABLE);
    lv_img_set_src(ui->digital_settings_phoenix_emoji, &_phoenix_bird_alpha_75x75);
    lv_img_set_pivot(ui->digital_settings_phoenix_emoji, 50,50);
    lv_img_set_angle(ui->digital_settings_phoenix_emoji, 0);
    lv_obj_set_pos(ui->digital_settings_phoenix_emoji, 127, 69);
    lv_obj_set_size(ui->digital_settings_phoenix_emoji, 75, 75);

    //Write style for digital_settings_phoenix_emoji, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_img_recolor_opa(ui->digital_settings_phoenix_emoji, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_img_opa(ui->digital_settings_phoenix_emoji, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->digital_settings_phoenix_emoji, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(ui->digital_settings_phoenix_emoji, true, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes digital_settings_lizzard_emoji
    ui->digital_settings_lizzard_emoji = lv_img_create(ui->digital_settings);
    ...
    lv_obj_set_pos(ui->digital_settings_lizzard_emoji, 40, 65);
    ...
    //Write codes digital_settings_cat_emoji
    ui->digital_settings_cat_emoji = lv_img_create(ui->digital_settings);
    lv_obj_add_flag(ui->digital_settings_cat_emoji, LV_OBJ_FLAG_CLICKABLE);
    lv_img_set_src(ui->digital_settings_cat_emoji, &_cat_emoji_alpha_75x75);
    lv_img_set_pivot(ui->digital_settings_cat_emoji, 50,50);
    lv_img_set_angle(ui->digital_settings_cat_emoji, 0);
    lv_obj_set_pos(ui->digital_settings_cat_emoji, 127, 151);
    lv_obj_set_size(ui->digital_settings_cat_emoji, 75, 75);

    //Write style for digital_settings_cat_emoji, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_img_recolor_opa(ui->digital_settings_cat_emoji, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_img_opa(ui->digital_settings_cat_emoji, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->digital_settings_cat_emoji, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(ui->digital_settings_cat_emoji, true, LV_PART_MAIN|LV_STATE_DEFAULT);
