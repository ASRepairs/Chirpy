...
void setup_scr_groups_contacts(lv_ui *ui)
{
    ...
    lv_img_set_src(ui->groups_contacts_img_close, &_close_icon_alpha_20x20);
    lv_img_set_pivot(ui->groups_contacts_img_close, 50,50);
    lv_img_set_angle(ui->groups_contacts_img_close, 0);
    lv_obj_set_pos(ui->groups_contacts_img_close, 17, 18);
    lv_obj_set_size(ui->groups_contacts_img_close, 20, 20);
    ...
    lv_obj_set_style_img_recolor_opa(ui->groups_contacts_img_close, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
