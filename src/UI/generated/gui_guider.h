...
typedef struct
{
	...
	lv_obj_t *home_messages_messages_menu_button_label;
	lv_obj_t *home_messages_label_messages;
	...
	lv_obj_t *message_received_like_img_1;
	...
	lv_obj_t *message_received_wave_img_1;
	...
	lv_obj_t *message_received_heart_img_1;
	...
	lv_obj_t *message_received_party_img_1;
	...
	lv_obj_t *alert_received;
	bool alert_received_del;
	lv_obj_t *alert_received_img_top_grey_bar;
	lv_obj_t *alert_received_label_alert_bar;
	lv_obj_t *alert_received_alert_button;
	lv_obj_t *alert_received_alert_button_label;
	lv_obj_t *alert_received_img_close;
	lv_obj_t *alert_received_label_1;
	lv_obj_t *alert_received_img_1;
	lv_obj_t *alert_send_failed;
	bool alert_send_failed_del;
	lv_obj_t *alert_send_failed_img_top_grey_bar;
	lv_obj_t *alert_send_failed_label_alert_bar;
	lv_obj_t *alert_send_failed_img_close;
	lv_obj_t *alert_send_failed_label_1;
	lv_obj_t *alert_send_successful;
	bool alert_send_successful_del;
	lv_obj_t *alert_send_successful_img_top_grey_bar;
	lv_obj_t *alert_send_successful_label_alert_bar;
	lv_obj_t *alert_send_successful_img_close;
	lv_obj_t *alert_send_successful_label_1;
...
LV_IMG_DECLARE(_x_thin_alpha_40x40);
LV_IMG_DECLARE(_emoji_1_alpha_80x80);
LV_IMG_DECLARE(_dog_emoji_alpha_30x30);
LV_IMG_DECLARE(_menu_bar_alpha_240x55);
LV_IMG_DECLARE(_x_thin_alpha_40x40);
LV_IMG_DECLARE(_emoji_2_alpha_80x80);
LV_IMG_DECLARE(_dog_emoji_alpha_30x30);
