...
static void home_menu_messages_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_GESTURE:
    {
        ...
        {
            lv_indev_wait_release(lv_indev_get_act());
            ui_load_scr_animation(&guider_ui, &guider_ui.home_menu_alert, guider_ui.home_menu_alert_del, &guider_ui.home_menu_messages_del, setup_scr_home_menu_alert, LV_SCR_LOAD_ANIM_OVER_TOP, 200, 200, false, true);
            break;
        }
        default:
            break;
...
static void home_menu_messages_messages_menu_button_event_handler (lv_event_t *e)
{
    ...
    {
        ui_load_scr_animation(&guider_ui, &guider_ui.messages_emoji_send_v2, guider_ui.messages_emoji_send_v2_del, &guider_ui.home_menu_messages_del, setup_scr_messages_emoji_send_v2, LV_SCR_LOAD_ANIM_MOVE_LEFT, 200, 200, false, true);
        break;
    }
    default:
        break;
...
static void home_menu_alert_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_GESTURE:
    {
        ...
        {
            lv_indev_wait_release(lv_indev_get_act());
            ui_load_scr_animation(&guider_ui, &guider_ui.home_menu_messages, guider_ui.home_menu_messages_del, &guider_ui.home_menu_alert_del, setup_scr_home_menu_messages, LV_SCR_LOAD_ANIM_OVER_BOTTOM, 200, 200, false, true);
            break;
        }
        case LV_DIR_TOP:
        {
...
static void messages_emoji_send_v2_img_close_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_CLICKED:
    {
        ui_load_scr_animation(&guider_ui, &guider_ui.home_menu_messages, guider_ui.home_menu_messages_del, &guider_ui.messages_emoji_send_v2_del, setup_scr_home_menu_messages, LV_SCR_LOAD_ANIM_OVER_RIGHT, 200, 200, false, true);
        break;
    }
    default:
        break;
