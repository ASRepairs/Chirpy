...
static void alert_menu_alert_button_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_CLICKED:
    {
        ...
        if(!status) {
            //&guider_ui, &guider_ui.home_digital, guider_ui.home_digital_del, &guider_ui.message_received_heart_del, setup_scr_home_digital
            ui_load_scr_animation(&guider_ui, &guider_ui.alert_send_successful, guider_ui.alert_send_successful_del, &guider_ui.alert_send_successful_del, setup_scr_alert_send_successful, LV_SCR_LOAD_ANIM_OVER_LEFT, 200, 200, false, true);
        } else {
            ui_load_scr_animation(&guider_ui, &guider_ui.alert_send_failed, guider_ui.alert_send_failed_del, &guider_ui.alert_send_failed_del, setup_scr_alert_send_failed, LV_SCR_LOAD_ANIM_OVER_LEFT, 200, 200, false, true);
        }
        break;
    }
    default:
