...
// SPI Stuff
#if CONFIG_SPI2_HOST_SX126X
#define HOST_ID SPI2_HOST
#elif CONFIG_SPI3_HOST_SX126X
...
void LoRaInit(void)
{
	ESP_LOGI(TAG, "CONFIG_MISO_GPIO=%d", CONFIG_SX126X_MISO_GPIO);
	ESP_LOGI(TAG, "CONFIG_MOSI_GPIO=%d", CONFIG_SX126X_MOSI_GPIO);
	ESP_LOGI(TAG, "CONFIG_SCLK_GPIO=%d", CONFIG_SX126X_SCLK_GPIO);
	ESP_LOGI(TAG, "CONFIG_NSS_GPIO=%d", CONFIG_SX126X_NSS_GPIO);
	ESP_LOGI(TAG, "CONFIG_RST_GPIO=%d", CONFIG_SX126X_RST_GPIO);
	ESP_LOGI(TAG, "CONFIG_BUSY_GPIO=%d", CONFIG_SX126X_BUSY_GPIO);
	ESP_LOGI(TAG, "CONFIG_TXEN_GPIO=%d", CONFIG_SX126X_TXEN_GPIO);
	ESP_LOGI(TAG, "CONFIG_RXEN_GPIO=%d", CONFIG_SX126X_RXEN_GPIO);

	SX126x_SPI_SELECT = CONFIG_SX126X_NSS_GPIO;
	SX126x_RESET = CONFIG_SX126X_RST_GPIO;
	SX126x_BUSY	= CONFIG_SX126X_BUSY_GPIO;
	SX126x_TXEN	= CONFIG_SX126X_TXEN_GPIO;
	SX126x_RXEN	= CONFIG_SX126X_RXEN_GPIO;
	...
	spi_bus_config_t spi_bus_config = {
		.sclk_io_num = CONFIG_SX126X_SCLK_GPIO,
